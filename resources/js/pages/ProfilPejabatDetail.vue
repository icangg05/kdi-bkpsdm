      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-8">
        ...
        <div
          ...
          <div class="relative p-4 lg:p-0">
            ...
            <div
              class="absolute top-6 left-6 lg:top-4 lg:left-4 bg-gradient-to-r from-sky-500 to-sky-600 text-white text-xs font-semibold flex items-center gap-2 px-3 py-1.5 rounded-full shadow-lg">
          ...
          <div class="p-5 text-center">
            ...
            <div class="mt-3 space-y-1">
              ...
              <p v-if="data.jabatan.unit_organisasi.bagian.nama && (data.jabatan.unit_organisasi.bagian.nama != data.jabatan.unit_organisasi.nama)"
