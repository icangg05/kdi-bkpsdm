...
<template>
  <div class="px-4 lg:px-[4%] absolute top-0 left-0 right-0 z-[990] text-white/90 select-none">
    <!-- Top nav -->
    ...
    <nav class="mt-3 lg:mt-0 bg-black/15 backdrop-blur-md text-white/95">
      <div class="px-5 py-2 lg:py-2 lg:px-6 flex items-center justify-between">
        <!-- Logo -->
        <AppLogo />
