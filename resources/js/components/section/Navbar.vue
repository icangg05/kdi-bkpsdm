...
import { ChevronDown, Facebook, Info, Instagram, Menu, Phone, TwitterIcon, Youtube, X } from 'lucide-vue-next';
    ...
    <div class="py-2 hidden lg:block">
      <div class="flex justify-between items-center">
        ...
        <div class="inline-flex items-center gap-5">
          <a :href="fb" target="_blank"><Facebook class="size-4" /></a>
          <a :href="tt" target="_blank"><TwitterIcon class="size-4" /></a>
          <a :href="yt" target="_blank"><Youtube class="size-4" /></a>
          <a :href="ig" target="_blank"><Instagram class="size-4" /></a>
        </div>
      </div>
    </div>
