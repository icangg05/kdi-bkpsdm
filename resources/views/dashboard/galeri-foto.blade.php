...
@section('content')
	...
	<x-breadcrumb
		:title="$title"
		:list="[[$title, route('dashboard.galeri.foto.index')], ['Index']]" />
	<!-- [ breadcrumb ] end -->
	...
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="mb-3">
				<a href="{{ route('dashboard.galeri.foto.create') }}" class="btn btn-primary">Tambah Data</a>
			</div>
				...
				<div class="card-body table-responsive">
                    ...
                    <img class="img-thumbnail" width="200" src="{{ asset("storage/$item->gambar") }}" alt="{{ $item->gambar }}">
									...
									<td class="text-nowrap">
										...
										<form class="d-inline" action="{{ route('dashboard.galeri.foto.destroy', $item->id) }}"
											method="post">
											@method('delete')
											@csrf
